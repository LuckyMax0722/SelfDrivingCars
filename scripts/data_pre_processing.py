...
from lib.utils import data_pre_processing, data_augmentation_flip, data_augmentation_translate, \
...
if __name__ == "__main__":
    ...
    if CONF.data_augmentation.random_erasing:
        images, steering_angles, erasing_images_path, steering_angles_temp = data_augmentation_random_erasing(images,
                                                                                                              steering_angles)
